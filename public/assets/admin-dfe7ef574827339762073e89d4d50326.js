...
(function() {
  $(document).on('page:change', function() {
    $('form.edit_shop_info').on('click', '#enable-password-field', function() {
      $('#enable-password-field').hide();
      $('#disable-password-field').show();
      $('#shop_info_password').removeAttr('disabled');
      return $('label[for=shop_info_password]').addClass('required');
    });
    return $('form.edit_shop_info').on('click', '#disable-password-field', function() {
      $('#disable-password-field').hide();
      $('#enable-password-field').show();
      $('#shop_info_password').attr('disabled', 'disabled');
      return $('label[for=shop_info_password]').removeClass('required');
    });
  });
